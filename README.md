...
-----------------------------------
⚠️Отказ от ответственности⚠️
-----------------------------------
❗❗❗ ВНИМАНИЕ! ❗❗❗
-----------------------------------
✅ Этот скрипт предназначен ИСКЛЮЧИТЕЛЬНО для образовательных и исследовательских целей. Автор не несет ответственности за любое неправомерное использование этого скрипта
-----------------------------------
